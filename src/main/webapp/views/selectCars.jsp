...
<table id="dg" title="汽车信息管理" class="easyui-datagrid" pagination="true"
...
<div id="tb">
    ...
    <div>
        &nbsp;品牌：&nbsp;<input type="text" id="carName" size="20"
...
<div id="dlg" class="easyui-dialog"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                <td>品牌：</td>
                <td><input type="text" id="title" name="carName"
...
<script type="text/javascript">
    ...
    function saveArticle() {
        ...
        var data = {"id": id, "carName": title, "articleContent": content, "addName": addName}
        $.ajax({
            type: method,//方法类型
            dataType: "json",//预期服务器返回的数据类型
            url: url,//url
